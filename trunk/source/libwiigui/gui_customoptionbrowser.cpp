 ...
 */
GuiCustomOptionBrowser::GuiCustomOptionBrowser(int w, int h, customOptionList * l, const u8 *imagebg, int scrollon,int col2,int start)
{
	width = w;
	height = h;
	options = l;
